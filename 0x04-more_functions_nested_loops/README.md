...
- You are not allowed to use the standard library. Any use of functions like `printf`, `put`s, etc… is forbidden
...
Write a program that finds and prints the largest prime factor of the number `6`12852475143`, followed by a new line.
